...
const baseConfig: AppConfig = {
  ...
  herokuApiToken: undefined,
  slackSigningSecret: undefined,
  slackAllowedTeamIds: [],
  slackAllowedEnterpriseIds: [],
  slackAllowedUserIds: [],
  slackDeployAllowedApps: [],
  slackDeployAllowedRepos: [],
  slackEnableGenericExecute: false,
